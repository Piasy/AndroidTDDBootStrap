...
public class GithubAPIErrorTest {
    ...
    public void testSerialize() {
        GithubAPIError converted = mGson.fromJson(MockProvider.provideGithubAPIErrorStr(), GithubAPIError.class);
        try {
            JSONAssert.assertEquals(MockProvider.provideGithubAPIErrorStr(), mGson.toJson(converted), false);
